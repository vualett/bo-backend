export default function getState(zipString) {
  ...
  if (typeof zipString !== 'string') {
    throw new Meteor.Error('Must pass the zipcode as a string.');
  }

  /* Ensure we have exactly 5 characters to parse */
  if (zipString.length !== 5) {
    throw new Meteor.Error('Must pass a 5-digit zipcode.');
  }
  ...
  if (zipcode >= 35000 && zipcode <= 36999) {
    ...
    st = 'none';
    state = 'none';
    throw new Meteor.Error('No state found matching' + zipcode);
  }
